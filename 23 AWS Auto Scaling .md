...
| 2️⃣     | 📄  Create Launch Template             | 🖥️ Define `AMI`, `instance type`, `key pair`, `security group`  |
| 3️⃣     | ⚙️  Add Instance Details               | 💾 Storage, 🔐 IAM role, 🧾 user data (optional)               |
| 4️⃣     | 📈 Create ASG                         | 🚀 Click **Create Auto Scaling Group**                          |
| 5️⃣     | 📌 Choose Template                    | 📄 Use created launch template                                  |
...
| 8️⃣     | 📊 Set Group Size                      | 🔢 Set Minimum, Desired=2, and Maximum (4) instances.         |
| 9️⃣     | 🔄 Scaling Policies (Add Rules)         | 🎯 CPU target (e.g., `50%`), step/scheduled scaling           |
| 🔟     | ❤️ Health Checks                        | 🔍 EC2 or ELB health checks to replace unhealthy instances  |
| 1️⃣1️⃣  | 🔔 Notifications                       | 📩 SNS alerts for scaling events                               |
| 1️⃣2️⃣  | 🔍 Review                               | 👀 Check all settings                                        |
| 1️⃣3️⃣  | 🚀 Create                              | ⚡ Click Create Auto Scaling Group                             |
...
📝 Configure Trail Settings
          ⬇️
🪣 Select S3 Bucket   (🗂️ Create/select S3 bucket for logs )
          ⬇️
🔒 Enable Encryption
          ⬇️
📊 Configure CloudWatch Logs
          ⬇️
🎯 Select Event Types   (Enable Logging to 🔍 Track API calls (Read/Write))
          ⬇️
✅ Create Trail
          ⬇️
